          ...
          <section className="mb-32">
            <div className="flex flex-wrap">
              <div className="mb-10 w-full">
                <h2 className="mb-4 text-3xl font-bold text-black ">Privacy Policy</h2>
                ...
                <p className="text-base mb-6 text-black">
                  <span className="font-semibold">Country refers to</span> means
                  a unique account created for You to access our Service or
                  parts of our Service.
                </p>
                <p className="text-base mb-6 text-black">
                  <span className="font-semibold">Account</span> : Delhi, India
                </p>
                <p className="text-base mb-6 text-black">
                ...
                <h4 className="mb-2 font-bold text-black ">Types of Data Collected</h4>
                <h4 className="mb-2 font-bold text-black ">Personal Data</h4>
                <p className="mb-2 text-black">
                ...
                <p className="mb-1 text-black">Email address</p>
                <p className="mb-1 text-black">First name and last name</p>
                <p className="mb-1 text-black">Phone number</p>
                <p className="mb-6 text-black">Usage Data</p>
                <h4 className="mb-2 font-bold text-black ">Usage Data</h4>
                <p className="mb-2 text-black">
                ...
                <p className="font-semibold mb-4 text-black">Necessary / Essential Cookies .</p>
                ...
                <h4 className="mb-2 font-bold text-black ">Use of Your Personal Data</h4>
                <p className="mb-6 text-black">
                ...
                <h4 className="mb-2 font-bold text-black ">Delete Your Personal Data</h4>
                <p className="mb-6 text-black">
                  Tou have the right to delete or request that We assist in
                ...
                <h4 className="mb-2 font-bold text-black ">Business Transactions</h4>
                <p className="mb-6 text-black">
                ...
                <h4 className="mb-2 font-bold text-black ">Law enforcement</h4>
                <p className="mb-6 text-black">
                ...
                <h4 className="mb-2 font-bold text-black ">Other legal requirements</h4>
                <p className="mb-6 text-black">
                ...
                <h4 className="mb-2 font-bold text-black ">Children&apos;s Privacy</h4>
                <p className="mb-6 text-black">
                ...
                <h4 className="mb-2 font-bold text-black ">Links to Other Websites</h4>
                <p className="mb-6 text-black">
