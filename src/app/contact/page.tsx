          ...
          <section className="mb-32">
            <div className="flex flex-wrap">
              <div className="mb-10 w-full">
                ...
                <h4 className="text-black font-bold">Phone No</h4>
                <p className="mb-10 text-black"> You can speak with our team directly by calling : +91 8851840604</p>
                <h4 className="text-black font-bold">E-mail</h4>
                <p className="mb-2 text-black"> For inquiries or assistance, you can reach us via email at : letzkhello@gmail.com</p>
              </div>
            </div>
          </section>
        </div>
