          ...
          <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="mt-12 flex">
              <div>
                ...
                <div className="mt-5">
                <h2 className="text-3xl font-extrabold text-gray-900">Mission</h2>
            ...
            <div>
              ...
              <div className="mt-5">
              <h2 className="text-3xl font-extrabold text-gray-900">What we Offers</h2>
            ...
            <div>
              ...
              <div className="mt-5">
              <h2 className="text-3xl font-extrabold text-gray-900">Why Choose Letzkhelo?</h2>
                <p className="mt-2 text-base text-gray-500  mb-5">
