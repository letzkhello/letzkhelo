          ...
          <section className="mb-32">
            <div className="flex flex-wrap">
              <div className="mb-10 w-full">
                ...
                <h4 className="mb-2 font-bold ">Interpretation</h4>
                <p className="mb-6 text-[#585858]">
                ...
                <h4 className="text-black-600 font-bold">Definitions</h4>
                <p className="mb-2 text-[#585858]">
                ...
                <h4 className="mb-2 font-bold ">Types of Data Collected</h4>
                <h4 className="mb-2 font-bold ">Personal Data</h4>
                <p className="mb-2 text-[#585858]">
                ...
                <p className="mb-1 text-[#585858]">Email address</p>
                <p className="mb-1 text-[#585858]">First name and last name</p>
                <p className="mb-1 text-[#585858]">Phone number</p>
                <p className="mb-6 text-[#585858]">Usage Data</p>
                <h4 className="mb-2 font-bold ">Usage Data</h4>
                <p className="mb-2 text-[#585858]">
                ...
                <p className="font-semibold mb-4">Necessary / Essential Cookies .</p>
                <p className="mb-4 text-[#585858]">Type: Session Cookies</p>
                <p className="mb-4 text-[#585858]">Administered by: Us</p>
                <p className="mb-4 text-[#585858]">
                ...
                <p className="mb-4 text-[#585858]">Type: Persistent Cookies</p>
                <p className="mb-4 text-[#585858]">Administered by: Us</p>
                <p className="mb-4 text-[#585858]">
                  Purpose: These Cookies identify if users have accepted the use
                  of cookies on the Website
                </p>
                <p className="font-semibold mb-4">Functionality Cookies</p>
                <p className="mb-4 text-[#585858]">Type: Persistent Cookies</p>
                <p className="mb-4 text-[#585858]">Administered by: Us</p>
                <p className="mb-4 text-[#585858]">
                ...
                <h4 className="mb-2 font-bold ">Use of Your Personal Data</h4>
                <p className="mb-6 text-[#585858]">
                ...
                <h4 className="mb-2 font-bold ">Delete Your Personal Data</h4>
                <p className="mb-6 text-[#585858]">
