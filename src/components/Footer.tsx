  ...
  return (
   ...
   mt-10">
        ...
        <nav>
          ...
          <Link href={'/termandCondition'} className="link link-hover text-white">Terms of use</Link>
          <Link href={'/privacyPolicy'} className="link link-hover text-white">Privacy policy</Link>
          <Link href={'/cookiesPolicy'} className="link link-hover text-white">Cookie policy</Link>
        </nav>
        <nav>
