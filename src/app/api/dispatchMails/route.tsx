...
async function sendEmail(user:any) {  
    let mailOptions = {  
      ...
      <p>We are thrilled to announce that <b>Letzkhelo</b> is making a comeback! Mark your calendars for <b>March 31st</b>, as we are gearing up to host another electrifying Arm Wrestling event. Get ready to unleash your inner strength and compete against fellow athletes in a display of power and skill.</p>  
      <p>Registration for the event will open on <b>March 25th</b>. Please note that spots are limited, and once registration closes, they will not be available. This is your chance to seize the opportunity and showcase your prowess on the arm wrestling stage.</p>  
      ...
      +91 87438 37089, +91 87438 37089  </p>  
    `};  
...
export async function GET(request: NextRequest) {
    ...
    // const users = [{email: "abhishek.sharma.letzkhelo@gmail.com", name: "Abhishek Sharma"}]
