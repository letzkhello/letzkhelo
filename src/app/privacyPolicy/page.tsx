          ...
          <section className="mb-32">
            <div className="flex flex-wrap">
              <div className="mb-10 w-full">
                <h2 className="mb-4 text-3xl font-bold text-white ">Privacy Policy</h2>
                ...
                <h4 className="mb-2 font-bold text-white ">Types of Data Collected</h4>
                <h4 className="mb-2 font-bold text-white ">Personal Data</h4>
                <p className="mb-2 text-white">
                ...
                <p className="mb-1 text-white">Email address</p>
                <p className="mb-1 text-white">First name and last name</p>
                <p className="mb-1 text-white">Phone number</p>
                <p className="mb-6 text-white">Usage Data</p>
                <h4 className="mb-2 font-bold text-white ">Usage Data</h4>
                <p className="mb-2 text-white">
                ...
                <p className="font-semibold mb-4 text-white">Necessary / Essential Cookies .</p>
                ...
                <h4 className="mb-2 font-bold text-white ">Use of Your Personal Data</h4>
                <p className="mb-6 text-white">
                ...
                <h4 className="mb-2 font-bold text-white ">Delete Your Personal Data</h4>
                <p className="mb-6 text-white">
                ...
                <h4 className="mb-2 font-bold text-white ">Business Transactions</h4>
                <p className="mb-6 text-white">
                ...
                <h4 className="mb-2 font-bold text-white ">Law enforcement</h4>
                <p className="mb-6 text-white">
                ...
                <h4 className="mb-2 font-bold text-white ">Other legal requirements</h4>
                <p className="mb-6 text-white">
                ...
                <h4 className="mb-2 font-bold text-white ">Children&apos;s Privacy</h4>
                <p className="mb-6 text-white">
                ...
                <h4 className="mb-2 font-bold text-white ">Links to Other Websites</h4>
                <p className="mb-6 text-white">
